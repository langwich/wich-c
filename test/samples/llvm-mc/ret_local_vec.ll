...
store %struct.PVector_ptr %5, %struct.PVector_ptr* %retval_
br label %ret_
return.exit_0:
br label %ret__
ret__:
...
%____num_roots = call i32 (...) @gc_num_roots()
store i32 %____num_roots, i32* %_funcsp, align 4
%0 = call %struct.PVector_ptr () @f()
%1 = call %struct.PVector_ptr () @f()
%2 = call %struct.PVector_ptr (%struct.PVector_ptr,%struct.PVector_ptr) @Vector_add(%struct.PVector_ptr %0,%struct.PVector_ptr %1)
