...
%y0_ = alloca double
%0 = fadd double 1.0, 0.00
store double %0, double* %y0_
%1 = load i32, i32* %x0_
%promo0 = sitofp i32 %1 to double
%2 = load double, double* %y0_
%3 = fsub double 0.0, %2
%4 = fadd double %promo0, %3
store double %4, double* %retval_
br label %ret_
return.exit_0:
br label %ret__
ret__:
