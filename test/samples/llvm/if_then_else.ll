...
if.block_false_0:
%sl_6 = getelementptr [6 x i8], [6 x i8]* @sl.str1, i32 0, i32 0
...
@sl.str0 = private unnamed_addr constant [5 x i8] c"TRUE\00", align 1
@sl.str1 = private unnamed_addr constant [6 x i8] c"FALSE\00", align 1