...
%vec_5 = load %struct.PVector, %struct.PVector* %vec_5
%len_5 = extractvalue %struct.PVector %vec_5, 2
%promo3 = call  (double, i64) @Vector_from_float(double %6, i64 %len_5)
...
%vec_2 = load %struct.PVector, %struct.PVector* %vec_2
%len_2 = extractvalue %struct.PVector %vec_2, 2
%promo0 = call  (double, i64) @Vector_from_float(double %3, i64 %len_2)
