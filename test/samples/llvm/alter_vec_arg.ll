...
declare %struct.PVector_ptr @PVector_init(double, i64) #1

declare void @print_pvector(%struct.PVector_ptr) #1

declare %struct.PVector_ptr @PVector_new(double*, i64) #1

declare void @set_ith(%struct.PVector_ptr, i32, double) #1

declare double @ith(%struct.PVector_ptr, i32) #1

declare i8* @PVector_as_string(%struct.PVector_ptr) #1
...
call void (%struct.PVector_ptr, i32, double) @set_ith(%struct.PVector_ptr %0, i32 0, double 100.00e+00)
